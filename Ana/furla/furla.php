...
switch($sexo){
    case 1:
        echo "$nome $sobrenome, $idade Anos , $altura cm de Altura, Kg$peso, $nacion, Sexo Masculino";
        break;
    case 2:
        echo "$nome $sobrenome, $idade Anos, $altura cm de Altura, Kg$peso, $nacion, Sexo Feminino";
        break;
    case 3:
        echo "$nome $sobrenome, $idade Anos, $altura cm de Altura, Kg$peso, $nacion, Você não faz sexo 😥";
}
?>
</body>
</html>